...
int color=0;
int GetColor();
void DrawMaterialBudget(const char* name="epic_brycecanyon_service_only"){

     TFile *myRootFile = new TFile("comp.root","UPDATE");
     ...
     gSystem->Exec("mkdir Output");
  	TGeoManager::Import(Form("%s.root",name));
  ...
  int startnode = 0; int endnode = 11;
